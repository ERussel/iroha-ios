...
#pragma mark - ProposalRoot_FileDescriptor

static GPBFileDescriptor *ProposalRoot_FileDescriptor(void) {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:[Proposal class]
                                     rootClass:[ProposalRoot class]
                                          file:ProposalRoot_FileDescriptor()
                                        fields:fields
