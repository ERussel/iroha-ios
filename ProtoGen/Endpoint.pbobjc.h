 ...
 **/
GPB_FINAL @interface EndpointRoot : GPBRootObject
@end
...
GPB_FINAL @interface ToriiResponse : GPBMessage
...
GPB_FINAL @interface TxStatusRequest : GPBMessage
...
GPB_FINAL @interface TxList : GPBMessage
