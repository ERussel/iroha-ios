...
GPB_FINAL @interface Transaction_Payload : GPBMessage
...
GPB_FINAL @interface Transaction_Payload_BatchMeta : GPBMessage
...
GPB_FINAL @interface Transaction_Payload_ReducedPayload : GPBMessage
