...
typedef GPB_ENUM(Field) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
   **/
  Field_GPBUnrecognizedEnumeratorValue = kGPBUnrecognizedEnumeratorValue,
  Field_KCreatedTime = 0,
  Field_KPosition = 1,
};
 ...
 **/
BOOL Field_IsValidValue(int32_t value);

#pragma mark - Enum Direction

typedef GPB_ENUM(Direction) {
  /**
   * Value used if any message's field encounters a value that is not defined
   * by this enum. The message will also have C functions to get/set the rawValue
   * of the field.
   **/
  Direction_GPBUnrecognizedEnumeratorValue = kGPBUnrecognizedEnumeratorValue,
  Direction_KAscending = 0,
  Direction_KDescending = 1,
};
 ...
 * the time this source was generated.
 **/
BOOL Direction_IsValidValue(int32_t value);
 ...
 **/
GPB_FINAL @interface QueriesRoot : GPBRootObject
@end

#pragma mark - Ordering

typedef GPB_ENUM(Ordering_FieldNumber) {
  Ordering_FieldNumber_SequenceArray = 1,
};

GPB_FINAL @interface Ordering : GPBMessage

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<Ordering_FieldOrdering*> *sequenceArray;
...
typedef GPB_ENUM(Ordering_FieldOrdering_FieldNumber) {
  Ordering_FieldOrdering_FieldNumber_Field = 1,
  Ordering_FieldOrdering_FieldNumber_Direction = 2,
};

GPB_FINAL @interface Ordering_FieldOrdering : GPBMessage

@property(nonatomic, readwrite) Field field;
...
/**
 * Fetches the raw value of a @c Ordering_FieldOrdering's @c field property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t Ordering_FieldOrdering_Field_RawValue(Ordering_FieldOrdering *message);
/**
 * Sets the raw value of an @c Ordering_FieldOrdering's @c field property, allowing
...
/**
 * Fetches the raw value of a @c Ordering_FieldOrdering's @c direction property, even
 * if the value was not defined by the enum at the time the code was generated.
 **/
int32_t Ordering_FieldOrdering_Direction_RawValue(Ordering_FieldOrdering *message);
/**
 * Sets the raw value of an @c Ordering_FieldOrdering's @c direction property, allowing
 * it to be set to a value that was not defined by the enum at the time the code
 * was generated.
 **/
...
typedef GPB_ENUM(TxPaginationMeta_FieldNumber) {
  ...
  TxPaginationMeta_FieldNumber_Ordering = 3,
};
...
GPB_FINAL @interface TxPaginationMeta : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) Ordering *ordering;
...
GPB_FINAL @interface AssetPaginationMeta : GPBMessage
...
GPB_FINAL @interface GetAccount : GPBMessage
...
GPB_FINAL @interface GetBlock : GPBMessage
...
GPB_FINAL @interface GetSignatories : GPBMessage
...
GPB_FINAL @interface GetAccountTransactions : GPBMessage
...
GPB_FINAL @interface GetAccountAssetTransactions : GPBMessage
...
GPB_FINAL @interface GetTransactions : GPBMessage
...
GPB_FINAL @interface GetAccountAssets : GPBMessage
...
GPB_FINAL @interface AccountDetailPaginationMeta : GPBMessage
...
GPB_FINAL @interface GetAccountDetail : GPBMessage
...
GPB_FINAL @interface GetAssetInfo : GPBMessage
...
GPB_FINAL @interface GetRoles : GPBMessage
...
GPB_FINAL @interface GetRolePermissions : GPBMessage
...
GPB_FINAL @interface GetPendingTransactions : GPBMessage
...
GPB_FINAL @interface GetPeers : GPBMessage
...
GPB_FINAL @interface QueryPayloadMeta : GPBMessage
...
typedef GPB_ENUM(GetEngineReceipts_FieldNumber) {
  GetEngineReceipts_FieldNumber_TxHash = 1,
};

GPB_FINAL @interface GetEngineReceipts : GPBMessage
...
typedef GPB_ENUM(Query_Payload_FieldNumber) {
  ...
  Query_Payload_FieldNumber_GetEngineReceipts = 16,
};
...
typedef GPB_ENUM(Query_Payload_Query_OneOfCase) {
  ...
  Query_Payload_Query_OneOfCase_GetEngineReceipts = 16,
};

GPB_FINAL @interface Query_Payload : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) GetEngineReceipts *getEngineReceipts;
...
GPB_FINAL @interface BlocksQuery : GPBMessage
