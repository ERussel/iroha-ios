 ...
 **/
GPB_FINAL @interface QryResponsesRoot : GPBRootObject
@end
 ...
 * *** WSV data structure *** //
 **/
GPB_FINAL @interface Asset : GPBMessage
...
GPB_FINAL @interface Domain : GPBMessage
...
GPB_FINAL @interface AccountAsset : GPBMessage
 ...
 * *** Responses *** //
 **/
GPB_FINAL @interface AccountAssetResponse : GPBMessage
...
GPB_FINAL @interface AccountDetailResponse : GPBMessage
...
GPB_FINAL @interface AssetResponse : GPBMessage
...
GPB_FINAL @interface RolesResponse : GPBMessage
...
GPB_FINAL @interface RolePermissionsResponse : GPBMessage
...
GPB_FINAL @interface SignatoriesResponse : GPBMessage
...
GPB_FINAL @interface TransactionsResponse : GPBMessage
...
GPB_FINAL @interface TransactionsPageResponse : GPBMessage
...
GPB_FINAL @interface PendingTransactionsPageResponse : GPBMessage
...
GPB_FINAL @interface PendingTransactionsPageResponse_BatchInfo : GPBMessage
...
GPB_FINAL @interface PeersResponse : GPBMessage
...
typedef GPB_ENUM(EngineReceiptsResponse_FieldNumber) {
  EngineReceiptsResponse_FieldNumber_EngineReceiptsArray = 1,
};

GPB_FINAL @interface EngineReceiptsResponse : GPBMessage

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<EngineReceipt*> *engineReceiptsArray;
/** The number of items in @c engineReceiptsArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger engineReceiptsArray_Count;
...
typedef GPB_ENUM(QueryResponse_FieldNumber) {
  ...
  QueryResponse_FieldNumber_EngineReceiptsResponse = 15,
};
...
typedef GPB_ENUM(QueryResponse_Response_OneOfCase) {
  ...
  QueryResponse_Response_OneOfCase_EngineReceiptsResponse = 15,
};

GPB_FINAL @interface QueryResponse : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) EngineReceiptsResponse *engineReceiptsResponse;
...
GPB_FINAL @interface BlockResponse : GPBMessage
...
GPB_FINAL @interface BlockErrorResponse : GPBMessage
...
GPB_FINAL @interface BlockQueryResponse : GPBMessage
